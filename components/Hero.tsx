  ...
  return (
    <div className="relative w-full h-screen overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-[1200px] w-full px-8 md:px-12 flex flex-col justify-center h-full pt-20">
        ...
        {/* Main Headline */}
        <div className="space-y-4 md:space-y-6 mb-16 mt-12">
        ...
        <div className="opacity-0 animate-[fadeIn_1s_ease-out_1.2s_forwards]">
          <button 
            ...
            className="group flex items-center gap-2 px-8 py-3 border border-white/80 rounded-full text-white text-lg font-light hover:bg-white hover:text-black transition-all duration-300"
          >
            {t.aiButton}
      ...
      {/* Abstract Glowing Elements (Optional purely cosmetic touches to mimic screenshot reflection) */}
      <div className="absolute top-1/2 left-1/4 w-96 h-96 bg-purple-600/20 blur-[100px] rounded-full mix-blend-screen pointer-events-none"></div>
