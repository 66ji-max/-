export const translations = {
  zh: {
    ...
    aiSaas: {
      ...
      card2Title: '成分检测服务',
      card2Desc: '识别商品成分风险，检测标签、原料与目标市场合规问题 (普通版可体验)',
      card3Title: '智能物流',
  ...
  en: {
    ...
    aiSaas: {
      ...
      card2Title: 'Ingredient Compliance Check',
      card2Desc: 'Analyze product ingredients and detect compliance risks in labels, materials, and target markets. (Available for Basic plan)',
